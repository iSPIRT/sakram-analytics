...
CREATE USER test;
ALTER USER test WITH PASSWORD 'postgres';
GRANT ALL PRIVILAGES ON DATABASE twitter TO test;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public to test;
GRANT ALL PRIVILEGES ON TABLE user_store to test;
GRANT ALL PRIVILEGES ON TABLE media_store to test;
GRANT ALL PRIVILEGES ON TABLE tweet_store to test;
/*
